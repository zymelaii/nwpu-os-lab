...
; TODO2.1: The modification you need to do with LOADER is almost the same as that in BOOT
;          though some of the code resides in included files...
; Hint: The only problem is that, some information got lost during the transition from BOOT to LOADER...
Main:            ; <--- 从这里开始 *************
    mov    ax, cs
    mov    ds, ax
    mov    es, ax
